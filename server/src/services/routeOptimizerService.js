...
export const REGIONAL_HUBS = [
  ...
  },
  {
    ...
    shortName: 'Lucknow (Transport Nagar Hub)',
    city: 'Lucknow',
    address: 'Plot 42-B, Transport Nagar Phase-2, Near Shaheed Path, Lucknow, Uttar Pradesh 226012',
    lat: 26.782,
    lng: 80.892,
    coldStorageCapacity: '450 Tons',
    tempRange: '2°C - 5°C',
    type: 'Regional Wholesale & Cold Terminal',
  },
];
...
export const FARM_CLUSTERS = [
  ...
  {
    id: 'farm_lucknow_malihabad',
    farmName: 'Awadh Krishi FPO (Malihabad)',
    farmerName: 'Ramprasad Maurya',
    farmerMobile: '+91 94151 88721',
    location: 'Gram Kasmandi Kalan, Malihabad, Lucknow',
    address: 'Gram Kasmandi Kalan, Malihabad, Lucknow, Uttar Pradesh 226102',
    crop: 'Malihabad Organic Spinach & Greens (पालक)',
    commodityKey: 'spinach',
    quantity: '1.2 Tons',
    weightTons: 1.2,
    lat: 26.920,
    lng: 80.710,
    cluster: 'Awadh Malihabad Cluster',
    tempTarget: '3.5°C',
    priority: 'high',
  },
  {
    id: 'farm_lucknow_mohanlalganj',
    ...
    address: 'Kisan Path Junction, Mohanlalganj, Lucknow, Uttar Pradesh 226301',
    crop: 'Tender Bhindi / Okra (भिंडी)',
    commodityKey: 'okra',
    quantity: '950 kg',
    weightTons: 0.95,
    lat: 26.680,
    lng: 80.980,
    cluster: 'Mohanlalganj South Cluster',
    tempTarget: '8.0°C',
    priority: 'medium',
  },
  {
    id: 'farm_lucknow_bakshi',
    farmName: 'BKT Agri Cooperative FPO (Bakshi Ka Talab)',
    farmerName: 'Satyendra Pratap Singh',
    farmerMobile: '+91 94500 77631',
    location: 'Bakshi Ka Talab (BKT), Lucknow',
    address: 'Sitapur Road Highway Cluster, Bakshi Ka Talab, Lucknow, UP 226201',
    crop: 'Polyhouse Cucumbers & Tomatoes (खीरा व टमाटर)',
    commodityKey: 'tomato',
    quantity: '1.5 Tons',
    weightTons: 1.5,
    lat: 27.020,
    lng: 80.930,
    cluster: 'BKT North Corridor',
    tempTarget: '10.5°C',
    priority: 'medium',
  },
];
...
export const FLEET_VEHICLES = [
  ...
  },
  {
    ...
    type: 'Smart Chilled Multi-Zone Reefer (4.2T)',
    capacityTons: 4.2,
    mileageKmPerL: 5.8,
    co2KgPerKm: 0.52,
    minTempC: 1.5,
    ...
    idealFor: 'Awadh Green Corridor & Lucknow Expressways',
  },
];
