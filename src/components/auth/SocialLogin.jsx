...
export const SocialLogin = ({ onGoogleLogin, loading = false }) => {
  return (
    <div className="w-full">
      ...
      <div className="relative my-5 flex items-center justify-center">
        ...
        <div className="relative flex items-center gap-1.5 bg-white px-3 text-xs font-medium uppercase tracking-wider text-slate-400">
